...
{"Time":"2020-07-10T01:24:44.270295-05:00","Action":"output","Package":"go-test-report","Test":"TestFunc3","Output":"--- PASS: TestFunc3 (0.00s)\n"}
{"Time":"2020-07-10T01:24:44.270311-05:00","Action":"pass","Package":"go-test-report","Test":"TestFunc3","Elapsed":0}
`
	...
	assertions.Nil(err)
	assertions.Equal(3, tmplData.NumOfTestPassed)
	assertions.Equal(0, tmplData.NumOfTestFailed)
